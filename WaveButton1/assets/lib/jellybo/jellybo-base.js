...
Jellybo.Helpers = function ($) {
    ...
    function iconHelper1($parentElem, start, end) {
        var $rotationState = 0;
        var $rotationRun = 0;
        var $rotation = 0;
        ...
        function eventsOn() {
            $parentElem.on("mouseenter", onMouseEnter).on("mouseleave", onMouseLeave);
        }
        function eventsOff() {
            $parentElem.off("mouseenter", onMouseEnter).off("mouseleave", onMouseLeave);
        }
        return {
            eventsOn: eventsOn,
            eventsOff: eventsOff
